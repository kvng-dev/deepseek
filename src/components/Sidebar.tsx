...
const Sidebar = ({ expand, setExpand }: Props) => {
  ...
  return (
    <aside
      className={`flex flex-col justify-between h-screen bg-[#212327] pt-7 transition-all z-50 max-md:absolute max-md:h-screen ${
      ...
      <div>
        ...
        >
          ...
          <div
            ...
            className="group flex relative justify-center items-center hover:bg-gray-500/20 transition-all duration-300 h-9 w-9 aspect-square rounded-lg cursor-pointer"
          >
            ...
            <div
              ...
              } opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none duration-300`}
            >
        ...
        >
          ...
          />
          <div className="absolute w-max -top-12 -right-12 opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none duration-300">
            New Chat
